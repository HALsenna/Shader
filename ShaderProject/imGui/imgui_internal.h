...
//#endif
    ...
    IMGUI_API ImVec2        FindBestWindowPosForPopupEx(const ImVec2& ref_pos, const ImVec2& size, ImGuiDir* last_pos, const ImRect& r_outer, const ImRect& r_avoid, ImGuiPopupPositionPolicy policy);
    ...
    IMGUI_API void          NavMoveRequestSubmit(ImGuiDir move_pos, ImGuiDir clip_pos, ImGuiNavMoveFlags move_flags, ImGuiScrollFlags scroll_flags);
    IMGUI_API void          NavMoveRequestForward(ImGuiDir move_pos, ImGuiDir clip_pos, ImGuiNavMoveFlags move_flags, ImGuiScrollFlags scroll_flags);
    ...
    IMGUI_API void          TableSetColumnSortDirection(int column_n, ImGuiSortDirection sort_posection, bool append_to_sort_specs);
